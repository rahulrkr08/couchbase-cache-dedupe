...
class CouchbaseStorage {
  constructor (options = {}) {
    ...
    // Enable hash keys to handle long keys (default: true)
    this.useHashKeys = options.useHashKeys !== false
    this.maxKeyLength = options.maxKeyLength || 200 // Leave some room for prefix
  }
  ...
  _hashKey (key) {
    ...
    // If key is within limit, return as-is
